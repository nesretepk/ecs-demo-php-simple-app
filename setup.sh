...
apt-get update && install -y software-properties-common dirmngr vim net-tools sudo wget curl apt-utils awscli
apt-get update && install -y default-mysql-server
